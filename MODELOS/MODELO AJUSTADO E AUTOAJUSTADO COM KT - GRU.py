...
while(aux<valor_inteiro):
	...
	name4 = now
	os.mkdir(str(name4))
	caminho_destino = str('/home/davilemos/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/GRU/' + str(name4))
	...
	# load dataset
	dataset1 = read_csv('/home/davilemos/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/GRU/e1.csv', header=0, index_col=0, delimiter=',')
	...
	caminho_origem = str('/home/davilemos/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/GRU/ManDados.txt')
	...
	caminho_origem = str('/home/davilemos/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/GRU/DefTreinoMO.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/davilemos/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/GRU/CalcSKT.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/davilemos/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/GRU/GBoxP_SKT.png')
	shutil.move(caminho_origem, caminho_destino)
	caminho_origem = str('/home/davilemos/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/GRU/GDisp_SKT.png')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/davilemos/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/GRU/Log_SKT.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/davilemos/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/GRU/RS.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/davilemos/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/GRU/TreinoMA.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/davilemos/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/GRU/CalcCKT.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	# Salva a figura no Google Drive
	pyplot.savefig('/home/davilemos/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/GRU/GBoxP_CKT.png', dpi=dpi*2)
	...
	caminho_origem = str('/home/davilemos/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/GRU/GBoxP_CKT.png')
	shutil.move(caminho_origem, caminho_destino)
	caminho_origem = str('/home/davilemos/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/GRU/GDisp_CKT.png')
	shutil.move(caminho_origem, caminho_destino)
	...
	file = open('/home/davilemos/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/GRU/Log_CKT.txt', "w")
	file.write('P20 - Infestado' + '\n')
	file.write('Test RMSE:' + '%.3f' % rmse + '\n')
	file.write('R2 linear:' + str(r_value ** 2) + '\n')
	file.write("R2 Polinomial:" + str(r1) + '\r')
	...
	caminho_origem = str('/home/davilemos/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/GRU/Log_CKT.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/davilemos/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/GRU/KT')
	shutil.move(caminho_origem, caminho_destino)
...
log.write("A média de tempo de manipulação dos dados é: " + str(media4) + "s\n\n")
log.write("A média de tempo de execução de Definição do modelo e Treinamento sem KT é: " + str(media1) + "s\n\n")
log.write("A média de tempo dos cálculos sem KT é: " + str(media5) + "s\n\n")
log.write("A média de tempo de execução da Random Search é: " + str(media2) + "s\n\n")
log.write("A média de tempo de execução do Treinamento com KT é: " + str(media3) + "s\n\n")
